...
namespace Sakura {
    ...
    void Sprite::init(float x, float y, float width, float height, const char* texturePath, ResourceManager* resouceManager) {
        ...
        m_texture = resouceManager->getTexture(texturePath);
        ...
        //Tell opengl to bind the vertex buffer object
